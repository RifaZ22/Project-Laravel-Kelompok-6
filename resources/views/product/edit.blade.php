...
<head>
  ...
  <style>
    ...
    .img-thumb { width: 60px; height: 60px; object-fit: cover; border-radius: .25rem; }
  ...
  <div class="container py-5">
    <div class="card">
      <div
        ...
        <h2 class="h5 mb-0">Daftar Produk Sepatu</h2>
        <a href="{{ route('products.create') }}" class="btn btn-success">
          <i class="bi bi-plus-lg btn-icon me-1"></i> Tambah Produk
        </a>
      </div>
      <div class="card-body">
        @if(session('success'))
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="{{ route('products.edit', $p->id) }}"
                      ...
                      <i class="bi bi-pencil-square btn-icon me-1"></i>Edit
                    </a>
                    <form action="{{ route('products.destroy', $p->id) }}"
                      ...
                      <button class="btn btn-sm btn-danger">
                        <i class="bi bi-trash btn-icon me-1"></i>Hapus
                      </button>
                    </form>
                  </td>
                </tr>
